...
## Importing
Once you have your records formatted correctly (follow the steps in the above section), you can import your records into multiple forms from the *Import Multi Form Records* page (see the first section). Follow these steps to import your records:
